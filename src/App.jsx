...
const LYRICS_BY_CATEGORY = {
  pop: [
    ...
    {
      setup: "Yellow diamonds in the light",
      answer: "and we're standing side by side",
    ...
    {
      setup: "This hit that ice cold Michelle Pfeiffer",
      answer: "that white gold",
    ...
    {
      setup: "Tonight's the night let's live it up",
      answer: "I got my money let's spend it up",
    ...
    },
    {
      ...
      answer: "mommy shark doo doo doo doo doo doo",
    ...
    {
      setup: "She's just a girl and she's on fire",
      answer: "hotter than a fantasy lonely like a highway",
  ...
  rock: [
    ...
    },
    {
      ...
      answer: "cause I try and I try and I try and I try",
    ...
    {
      setup: "The heart is a bloom",
      answer: "shoots up through the stony ground",
    ...
    {
      setup: "See the stone set in your eyes",
      answer: "see the thorn twist in your side",
      hint: "U2 - With or Without You",
      searchTerm: "U2 With or Without You"
    },
    {
      setup: "Summer has come and passed",
      answer: "the innocent can never last",
    ...
    {
      setup: "I heard you crying loud",
      answer: "all the way across town",
